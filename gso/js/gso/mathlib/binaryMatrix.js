...
Gso.MathLib.BinaryMatrix = function BinaryMatrix(){
  ...
  this.getRow = function(rowNumberToGet) {
    ...
    //return Gso.MathLib.BinaryVector.newOne(this.elements[rowNumberToGet-1]);
  //  return binaryVector.setElements(this.elements[rowNumberToGet-1]);
 ...
 this.leftMultiply = function(binary_matrix) {
  ...
  if (typeof(tempMatrix[0][0]) === 'undefined')
  {
    tempMatrix = Gso.MathLib.BinaryMatrix.new_one.new_one(tempMatrix).elements;
  }
